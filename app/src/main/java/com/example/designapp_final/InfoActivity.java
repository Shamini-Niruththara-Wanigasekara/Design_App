...
public class InfoActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setting the name of cycle

        cycleName.setText("Avail");
    ...
    private boolean SaveCart() {
        ...
        if (addHelmet.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_HELMET, "Has Helmet: YES");
        } else {
            values.put(OrderContract.OrderEntry.COLUMN_HELMET, "Has Helmet: NO");

        }

        if (addAccessory.isChecked()) {
            values.put(OrderContract.OrderEntry.COLUMN_ACCESSORY, "Has Accessory: YES");
        } else {
            values.put(OrderContract.OrderEntry.COLUMN_ACCESSORY, "Has Accessory: NO");
