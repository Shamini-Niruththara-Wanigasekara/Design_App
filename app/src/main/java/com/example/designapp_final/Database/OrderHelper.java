package com.example.designapp_final.Database;
...
public class OrderHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String SQL_TABLE = "CREATE TABLE " + OrderContract.OrderEntry.TABLE_NAME + " ("
                ...
                +  OrderContract.OrderEntry.COLUMN_HELMET + " TEXT NOT NULL, "
                +  OrderContract.OrderEntry.COLUMN_ACCESSORY + " TEXT NOT NULL);";
